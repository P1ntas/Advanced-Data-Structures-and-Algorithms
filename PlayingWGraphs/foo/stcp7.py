...
# Preprocess the stops data to group similar stops by name
...
#pos = nx.spring_layout(G, k=1)  # Increase the distance between nodes
nx.draw(G, pos=node_positions, with_labels=False, node_size=100, arrowsize=15, node_color='lightblue', font_size=8, font_color='black', edge_color='black', width=0.5)
